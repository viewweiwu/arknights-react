...
const handleEdit = () => {
  ...
  ReactDOM.render(<RecruitEditor onClose={() => remove()} />, element)
}
      ...
      <ul className='open-list'>
        {data.map((item) => {
          ...
          switch (item.status) {
            case 'ready':
              chidlren = (
                <div className='item-empty btn' onClick={handleEdit}>
                ...
                <div className='item-searching'>
                  ...
                  <main>
                    ...
                    <div className='item-right'>
                      <img
                        src='http://prts.wiki/images/thumb/6/6a/%E9%81%93%E5%85%B7_%E5%B8%A6%E6%A1%86_%E9%BE%99%E9%97%A8%E5%B8%81.png/100px-%E9%81%93%E5%85%B7_%E5%B8%A6%E6%A1%86_%E9%BE%99%E9%97%A8%E5%B8%81.png'
                        alt=''
                      />
                      <img
                        src='http://prts.wiki/images/thumb/d/de/%E9%81%93%E5%85%B7_%E5%B8%A6%E6%A1%86_%E6%8B%9B%E8%81%98%E8%AE%B8%E5%8F%AF.png/100px-%E9%81%93%E5%85%B7_%E5%B8%A6%E6%A1%86_%E6%8B%9B%E8%81%98%E8%AE%B8%E5%8F%AF.png'
                        alt=''
                      />
                    </div>
                  </main>
                  <footer>
                    <AcButton size='large' onClick={() => handleCancel(item)}>
                      停止招募
                    </AcButton>
                    <AcButton size='large' onClick={() => finisheNow(item)}>
                      立即招募
                    </AcButton>
                  </footer>
                </div>
            ...
            case 'finished':
              chidlren = (
                <div className='item-finished'>
                  <p>已经找到部分符合要求的候选人</p>
                  <AcButton size='large' type='blue' onClick={() => handleConfirm()}>
                    聘用候选人
                  </AcButton>
                </div>
              )
