      ...
      <section className="home-user">
        <div className="home-user-level">
          ...
          <svg width="110" height="110">
            <circle cx="55" cy="55" r="50" stroke-width="4" stroke="rgba(255, 255, 255, .2)" fill="none"></circle>
            <circle cx="55" cy="55" r="50" stroke-width="4" stroke="#fe2" fill="none" transform="matrix(0,-1,1,0,0,110)" stroke-dasharray="200 314"></circle>
          </svg>
        </div>
