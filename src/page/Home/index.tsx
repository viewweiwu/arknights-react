...
// 能天使立绘
let cg = 'http://prts.wiki/images/1/13/%E7%AB%8B%E7%BB%98_%E8%83%BD%E5%A4%A9%E4%BD%BF_skin1.png'
  ...
  return (
    <div className='home'>
      <section className='chara-cg'>
        ...
        <img className='chara-cg-main' src={cg} alt='' height='1024' draggable='false' />
